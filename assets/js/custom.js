...
$(document).ready(function () {
    ...
    /* custom column categroy */
    /* language menu */
    $('#form-language').on('click', function () {
        $('#form-language #list-language').toggle('fast');
    });
    /* custom tabs */
    $('.nagi_custom_tabs').find('.nagi_custom_tabs_link:first, .nagi_custom_tabs_content:first').addClass('active');
    $('.nagi_custom_tabs .nagi_custom_tabs_link').on('click', function (e) {
        e.preventDefault();
        var tab_content = $(this).attr('href') + '.nagi_custom_tabs_content';
        $(this).closest('.nagi_custom_tabs').find('.nagi_custom_tabs_link, .nagi_custom_tabs_content').removeClass('active');
        $(this).addClass('active');
        $(tab_content).addClass('active');
    });
    
    $(".page-main-menu.main-nav .menu-item a").click(function(e) {
